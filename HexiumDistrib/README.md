...
> [!IMPORTANT]
> **Server and every client must run the exact same DvergrAllies version.** Since 1.0.8 a mismatched client is refused at connection with a screen showing both versions - update everyone together.
